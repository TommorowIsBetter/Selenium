...
class Update(unittest.TestCase):
    ...
    def test_update(self):
        ...
        driver.find_element_by_name("product_name").send_keys("3")
        driver.find_element_by_name("product_price").clear()
        driver.find_element_by_name("product_price").send_keys("3")
        driver.find_element_by_name("product_nums").clear()
        driver.find_element_by_name("product_nums").send_keys("3")
        driver.find_element_by_name("product_desc").clear()
        driver.find_element_by_name("product_desc").send_keys("1")
        driver.find_element_by_css_selector("input[type=\"submit\"]").click()
        driver.find_element_by_xpath(u"(//a[contains(text(),'更新')])[4]").click()
        driver.find_element_by_name("product_desc").clear()
        driver.find_element_by_name("product_desc").send_keys("55")
        driver.find_element_by_css_selector("input[type=\"submit\"]").click()
