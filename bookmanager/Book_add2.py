...
class AddBook2(unittest.TestCase):
    def setUp(self):
    ...
    def test_add_book2(self):
        ...
        driver.find_element_by_name("product_name").send_keys("123")
        driver.find_element_by_name("product_name").clear()
        driver.find_element_by_name("product_name").send_keys("123")
        driver.find_element_by_name("product_price").clear()
        driver.find_element_by_name("product_price").send_keys("2")
        driver.find_element_by_name("product_nums").clear()
        driver.find_element_by_name("product_nums").send_keys("2")
        driver.find_element_by_name("product_desc").clear()
        driver.find_element_by_name("product_desc").send_keys("2")
