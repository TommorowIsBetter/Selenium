...
class Viewdavid60(unittest.TestCase):
    def setUp(self):
    ...
    def test_viewdavid60(self):
        ...
        driver.find_element_by_id("clientName").send_keys("viewdavid60")
        ...
        driver.find_element_by_xpath("(//a[contains(text(),'Edit')])[9]").click()
